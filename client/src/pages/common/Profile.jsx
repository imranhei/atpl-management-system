...
const Profile = () => {
  ...
  return (
    <div className="rounded-md m-4 sm:space-y-4 space-y-3">
      <Box className="flex flex-col sm:flex-row items-center gap-8 h-fit sm:w-fit w-full bg-background sm:p-10 p-4 rounded">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="font-medium text-lg text-textHead">
